export const myLoveForMovies = {
    ...
    readTime: 10,
    tags: ["movies", "cinema", "personal", "lost-in-translation", "blade-runner"],
    content: `
  The desire for friction to imagine the world. The desire to imagine. The power to imagine. The power to dream.
  
  It's the most intriguing superpower one can truly hold.
  ...
  I don't remember exactly when I fell in love with movies, but I remember the *feeling*. That moment when the lights dim, the screen glows, and for the next two hours, you're somewhere else entirely. You're *someone* else entirely.
  
  I started consuming niche films pretty early. Not because I was trying to be pretentious or different—I just stumbled onto them and realized they hit different. They made me *feel* things that mainstream blockbusters didn't. They lingered. They stuck with me for days, weeks, sometimes years.
  
  Here are some of the films that touched me the most. Not reviews. Not ratings. Just... what they made me feel.
  ...
  That hotel bar scene. The quiet moments. The ending whisper we never hear.
  
  It taught me that loneliness isn't always something to fix. Sometimes it's just something to *feel*. And sometimes, a fleeting connection—even one that doesn't last—can mean everything.
  ...
  I first watched this when I was stuck in the exact kind of system the film critiques. Rules, expectations, paths already laid out for me. Do this, study that, follow the plan, don't ask questions.
  
  And then Robin Williams shows up as Mr. Keating and tears the whole thing apart. He tells these kids to think for themselves. To find their own voice. To stand on desks and see the world differently.
  ...
  I think about that "O Captain! My Captain!" scene more than I'd like to admit.
  ...
  Because it's about proximity without contact. It's about loving someone you can't hold. It's about the distance between two people who are *right there* but might as well be miles apart.
  ...
  It's not a perfect film, but it's *honest*. And sometimes that's enough.
  ...
  *Blade Runner 2049* took that question further: *What does it mean to matter?* K spends the entire film believing he's special, only to find out he's not. And then he makes the choice to matter anyway.
  ...
  Heavy stuff. But god, they're beautiful.
  
  ---
  
  ## Chasing Beauty (2013)
  
  This documentary messed me up because it pulled back the curtain on something I'd never really thought about: the modeling industry.
  
  It's not glamorous. It's brutal. These women are told they're too fat, too old, too *something* constantly. The film just follows them around—no dramatic music, no narrative tricks. Just reality.
  
  It made me think about beauty standards, about the industries we build around impossible ideals, about the cost of chasing something that's always just out of reach.
  ...
  That's the power. That's why I keep coming back.
