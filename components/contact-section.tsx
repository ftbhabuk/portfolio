      ...
      <div className="container-xl">
        ...
        >
          <div className="space-y-8">
            ...
            <motion.div variants={itemVariants} className="border-b border-foreground/10 pb-4">
              <div className="flex items-center justify-between">
                <span className="contact-label text-foreground/60">Twitter / X</span>
                <a
          ...
          <div className="space-y-8">
            <motion.div variants={itemVariants} className="border-b border-foreground/10 pb-4">
              <div className="flex items-center justify-between">
                ...
                <span className="contact-text text-foreground">Nepal</span>
              </div>
            </motion.div>

            <motion.div variants={itemVariants} className="border-b border-foreground/10 pb-4">
              <div className="flex items-center justify-between">
                <span className="contact-label text-foreground/60">Status</span>
                <span className="contact-text text-foreground">Open to Collaboration</span>
              </div>
            </motion.div>
          </div>
        </motion.div>
